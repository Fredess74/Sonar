...
export const Header = ({
  ...
  return (
    <div className="fixed top-4 left-1/2 -translate-x-1/2 z-30 flex items-center gap-4 w-[90%] max-w-2xl">
      ...
      {/* Search Island */}
      <div className="flex-1 bg-sonar-surface/80 backdrop-blur-xl border border-white/10 rounded-full h-12 px-4 flex items-center gap-3 shadow-neon transition-all hover:border-sonar-accent/30 group focus-within:border-sonar-accent/50 focus-within:shadow-neon-strong">
        ...
        <button
            className="p-1.5 hover:bg-white/10 rounded-full text-sonar-muted hover:text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-sonar-accent"
      ...
      <div className="bg-sonar-surface/80 backdrop-blur-xl border border-white/10 rounded-full h-12 px-2 flex items-center gap-1 shadow-lg">
        <button
            onClick={onPlanClick}
            className="p-2.5 rounded-full hover:bg-white/10 text-sonar-accent transition-colors relative group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-sonar-accent"
            title="Plan New Trip"
        ...
        {generatedOptions.length > 1 && (
            <button
                ...
                className="p-2.5 rounded-full hover:bg-white/10 text-white transition-colors relative group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-sonar-accent"
                title="Switch Route"
        ...
        <button
            ...
            className={`p-2.5 rounded-full transition-all duration-300 relative group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-sonar-accent ${
                isSimulating
