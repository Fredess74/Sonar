      ...
      <div className={`flex-1 overflow-y-auto overflow-x-hidden p-4 space-y-3 scrollbar-hide transition-opacity duration-300 ${isCollapsed ? 'opacity-0 hidden' : 'opacity-100'}`}>
         ...
         {selectedStep && selectedStep.place_card ? (
             <div className="animate-fade-in">
                 <button
                    onClick={() => onStepClick('')}
                    className="mb-4 text-sm text-sonar-muted hover:text-white flex items-center gap-1 transition-colors hover:translate-x-[-2px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sonar-accent rounded px-1 -ml-1"
                 >
