             ...
             <div className="relative pl-4 pb-20">
                ...
                {route.waypoints.map((wp, idx) => (
                    <button
                        ...
                        className={`relative group w-full text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sonar-accent flex items-start gap-4 p-3 rounded-xl cursor-pointer transition-all border
