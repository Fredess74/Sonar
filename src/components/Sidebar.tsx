             ...
             <div className="relative pl-4 pb-20">
                ...
                {route.waypoints.map((wp, idx) => (
                    <button
                        ...
                        className={`relative group flex items-start gap-4 p-3 rounded-xl cursor-pointer transition-all border w-full text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sonar-accent
                    ...
                    >
                        ...
                        <div className="flex-1 min-w-0">
                            <div className="flex justify-between items-center mb-0.5">
                                <span className={`font-medium text-sm truncate transition-colors block ${selectedStepId === wp.id ? 'text-sonar-accent' : 'text-white'}`}>
                                    {wp.name}
                                </span>
                                {wp.arrival_time && (
