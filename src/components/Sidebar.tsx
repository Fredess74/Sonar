             ...
             <div className="relative pl-4 pb-20">
                ...
                {route.waypoints.map((wp, idx) => (
                    <button
                        ...
                        className={`w-full text-left relative group flex items-start gap-4 p-3 rounded-xl cursor-pointer transition-all border focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sonar-accent focus-visible:ring-inset
